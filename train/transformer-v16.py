...
CFG.train_csv = f'/kaggle/input/bc24-audio-loop-{CFG.min_duration}sec-dataset-sync-500/train_metadata.csv'
spectrograms_pkl = f'/kaggle/input/bc24-audio-loop-{CFG.min_duration}sec-dataset-sync-500/ALL_t_{CFG.min_duration}_fs_32000.pkl'
